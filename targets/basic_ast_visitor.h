// $Id: basic_ast_visitor.h,v 1.3 2015/03/15 06:12:51 ist171015 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_constant_definition_node(pwn::constant_definition_node * const node, int lvl) = 0;
  ...
  virtual void do_import_node(pwn::import_node * const node, int lvl) = 0;

  virtual void do_local_node(pwn::local_node * const node, int lvl) = 0;

  virtual void do_next_node(pwn:: next_node * const node, int lvl) = 0;

  virtual void do_or_node(pwn::or_node * const node, int lvl) = 0;

  virtual void do_printnl_node(pwn::printnl_node * const node, int lvl) = 0;
  ...
  virtual void do_variable_definition_node(pwn::variable_definition_node * const node, int lvl) = 0;
