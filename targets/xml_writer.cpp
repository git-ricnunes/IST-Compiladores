// $Id: xml_writer.cpp,v 1.3 2015/03/15 06:12:51 ist171015 Exp $ -*- c++ -*-
#include <string>
...
void pwn::xml_writer::do_constant_definition_node(pwn::constant_definition_node * const node, int lvl){
  /*TODO*/;
}
 ...
 void pwn::xml_writer::do_import_node(pwn::import_node * const node, int lvl){
  /*TODO*/;
}

 void pwn::xml_writer::do_local_node(pwn::local_node * const node, int lvl){
  /*TODO*/;
}
 ...
 void pwn::xml_writer::do_printnl_node(pwn::printnl_node * const node, int lvl){
  /*TODO*/;
}
 ...
 void pwn::xml_writer::do_variable_definition_node(pwn::variable_definition_node * const node, int lvl){
  /*TODO*/;
}