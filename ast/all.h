...
namespace pwn {
class constant_definition_node; 
class print_node; 
class local_node; 
class printnl_node; 
class lvalue_node; 
class rvalue_node; 
class variable_definition_node; 
class repeat_node; 
...
#include "ast/constant_definition_node.h"
#include "ast/print_node.h"
#include "ast/local_node.h"
#include "ast/printnl_node.h"
#include "ast/lvalue_node.h"
#include "ast/rvalue_node.h"
#include "ast/variable_definition_node.h"
